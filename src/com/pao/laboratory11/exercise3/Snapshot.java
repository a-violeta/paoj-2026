...
public final class Snapshot {
    ...
    public Snapshot(Map<String, Long> byCountry,
                    Map<String, Long> byChannel,
                    BigDecimal total,
                    List<Transaction> top) {

        this.countByCountry = Collections.unmodifiableMap(byCountry);
        this.countByChannel = Collections.unmodifiableMap(byChannel);
