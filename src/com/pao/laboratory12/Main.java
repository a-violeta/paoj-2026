...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        // 1. stergem loan-ul creat anterior (ca sa nu incalcam FK)
        loanRepo.delete(loanId);
        audit.log("delete_loan_before_reader");
        System.out.println("10.1 Loan sters cu ID=" + loanId);

        // 2. acum putem sterge reader-ul
        readerRepo.delete(reader.getId());
        audit.log("delete_reader");
        System.out.println("10.2 Cititor sters cu ID=" + reader.getId());
