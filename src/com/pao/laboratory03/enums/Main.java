...
public class Main {
    public static void main(String[] args) {
        ...
        switch (selected) {
            case LOW -> System.out.println("Totul este sub control.");
            case MEDIUM -> System.out.println("Atenție moderată necesară.");
            case HIGH -> System.out.println("⚠️ Atenție! Prioritate ridicată!");
            case CRITICAL -> System.out.println("🚨 Situație critică! Acțiune imediată!");
        }
